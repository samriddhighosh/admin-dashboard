      ...
      <section className='mt-2.5 wrapper-md'>
        <form className='trip-form' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input id="duration" name="duration" type="number" placeholder='Enter a number of days' className='form-input placeholder:text-gray-100' onChange={(e)=> handleChange('duration',Number(e.target.value))}/>
          </div>
          {selectItems.map((key)=>(
            <div key={key}>
          ...
          <div>
            <label htmlFor='location'>
              Location on teh world map
            </label>
            <MapsComponent>
              <LayersDirective>
                <LayerDirective dataSource={mapData} shapeData={world_map} shapeDataPath='country' shapePropertyPath="name" shapeSettings={{colorValuePath:'color', fill:"#e5e5e5"}}/>
              </LayersDirective>
            </MapsComponent>
          </div>
          ...
          {error && (
            ...
            <footer className='px-6 w-full'>
              <ButtonComponent className='button-class !h-12 !w-full' disabled={loading} type='submit'>
